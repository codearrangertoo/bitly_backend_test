...
// InvitationGroup struct for InvitationGroup
...
func (o InvitationGroup) MarshalJSON() ([]byte, error) {
...
type NullableInvitationGroup struct {
	value *InvitationGroup
	isSet bool
}

func (v NullableInvitationGroup) Get() *InvitationGroup {
	return v.value
}

func (v *NullableInvitationGroup) Set(val *InvitationGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableInvitationGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableInvitationGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvitationGroup(val *InvitationGroup) *NullableInvitationGroup {
	return &NullableInvitationGroup{value: val, isSet: true}
}

func (v NullableInvitationGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvitationGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
