...
func (r ApiGetOrganizationShortenCountsRequest) Unit(unit string) ApiGetOrganizationShortenCountsRequest {
	r.unit = &unit
	return r
}
...
/*
 * GetOrganizationShortenCounts Get Shorten Counts for an Organization
